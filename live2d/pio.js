    ...
    var action = {
        ...
        buttons: function () {
            ...
            function setNightMode() {
                document.documentElement.style.backgroundColor = document.getElementsByClassName("site-content")[0].style.backgroundColor = "#333";
                document.body.classList.add("dark");
            }
 
            function resetNightMode() {
                document.documentElement.style.backgroundColor = document.getElementsByClassName("site-content")[0].style.backgroundColor = "";
                    ...
                    for (var j = 0; j < e.length; j++) {
                        if (t.type === "read") {
                            e[j].onmouseover = function () {
                                var message = this.innerText ? "想阅读 %t 吗？".replace(/%t/, "“" + this.innerText + "”") : "快打开看看吧！~";
                                modules.render(message);
                            }
                        }
                        else if (t.type === "link") {
                            e[j].onmouseover = function () {
                                var message = this.innerText ? "想了解一下 %t 吗？".replace(/%t/, "“" + this.innerText + "”") : "快打开看看吧！~";
                                modules.render(message);
                            }
                        }
                        else if (t.text) {
...
if (window.console && window.console.log) {
    console.log(
        `%c 沉梦小站cmxz.top %c 哈哈，你打开了控制台，是想要看看我的秘密吗？`,
